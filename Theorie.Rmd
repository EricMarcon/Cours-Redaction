...
- Quelques phrases de présentation du contexte.

- Définition du problème : quelles sont les questions larges sur le sujet ?

- Annonce de l'objectif : quelle est la contribution de l'article à la résolution du problème ?

- Bref état de l'art : la discussion commplètera la revue de la littérature, se limiter aux références les plus importantes.

- Énoncé de l'hypothèse de l'article : la question précise, à laquelle les résultats répondent directement.

- Si la conclusion est simple, la présenter ici brièvement.
